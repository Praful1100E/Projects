...
# The HTML template is updated to display initial AI analysis values.
INDEX_HTML_TEMPLATE = """
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    ...
    <div class="container">
        <div class="main">
            ...
            <h3>AI Analysis</h3>
            <!-- These values are now passed in directly on page load -->
...
def index():
    ...
    # --- FIX: Perform analysis on the latest reading for the initial view ---
    spoilage_risk = "N/A"
    anomaly_status = "N/A"
    if latest_reading:
...
def add_data():
    ...
    try:
        ...
        if is_anomaly:
            send_alert(anomaly_reason) # This now sends SMS
