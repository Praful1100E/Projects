...
if "pipe" not in st.session_state:
    ...
    if predict_button:
        # --- Smart Mapping and Prediction Logic ---
        ...
        base_pred_value = base_pred_array[0] # Extract the single number from the array
