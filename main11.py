...
<head>
    ...
    <style>
        /* --- Global Style & Color Palette (New Theme) --- */
        :root {
            --bg-color: #1f213a; /* Deep blue/purple background */
            --primary-widget-color: #2d304f; /* Lighter card background */
            --text-color: #e0e0fc; /* Light lavender text */
            --text-secondary-color: #a9b2d3; /* Muted text for labels/subtitles */
            --border-color: #4a4e8a; /* Subtle border for cards and inputs */
            --accent-color: #8a92ff; /* Vibrant lavender/blue for buttons and highlights */
            --accent-hover-color: #6c63ff; /* Darker accent for hover states */
            --risk-high-color: #ff5c8d; /* Pink/red for high risk */
            --risk-medium-color: #f0a32e; /* Orange for medium risk */
            --risk-low-color: #00d9a6; /* Bright green/teal for low risk */
        ...
        .main:hover, .sidebar:hover {
            border-color: var(--accent-color); /* Subtle hover effect */
        }
        ...
        h1 { 
            ...
            font-weight: 700;
            letter-spacing: 1px;
            text-shadow: 0 0 15px rgba(138, 146, 255, 0.4);
        }
        ...
        input[type="number"]:focus, select:focus {
            ...
            box-shadow: 0 0 0 3px rgba(138, 146, 255, 0.3); /* Softer glow */
        }
        ...
        /* Alert list styling - like chat bubbles */
        #alert-list { 
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function createChart(chartData) {
                ...
                // Create gradients for the chart fill
                const tempGradient = ctx.createLinearGradient(0, 0, 0, 300);
                tempGradient.addColorStop(0, 'rgba(255, 92, 141, 0.4)');
                tempGradient.addColorStop(1, 'rgba(255, 92, 141, 0)');

                const humGradient = ctx.createLinearGradient(0, 0, 0, 300);
                humGradient.addColorStop(0, 'rgba(138, 146, 255, 0.4)');
                humGradient.addColorStop(1, 'rgba(138, 146, 255, 0)');
                
                // Chart.js global defaults
                Chart.defaults.color = '#a9b2d3'; // --text-secondary-color
                        ...
                        datasets: [
                            {
                                ...
                                borderColor: '#ff5c8d', // --risk-high-color
                            ...
                            },
                            {
                                ...
                                borderColor: '#8a92ff', // --accent-color
                                backgroundColor: humGradient,
                                fill: true,
                                tension: 0.4,
                                yAxisID: 'y1',
                                borderWidth: 2,
                                pointBackgroundColor: '#8a92ff',
                                pointRadius: 4,
                                pointHoverRadius: 6
                            }
                        ]
                    ...
                    options: {
                        ...
                        scales: {
                            ...
                            x: {
                                ...
                                grid: { color: 'rgba(74, 78, 138, 0.2)' },
                                ticks: { color: '#a9b2d3', maxRotation: 0, autoSkip: true, maxTicksLimit: 10 }
                            }
                        }
                    }
                });
